...
// this is a Client Side comoponent and will not cause any changes on the server side of the application
...
const colors = ['#00C49F', '#0088FE', '#FFBE28'];
    ...
    return (
        <div className="row-span-3 bg-white shadow-md rounded-2xl flex flex-col justify-between">
            ...
            <div>
                <hr/>
                {expenseSummary && (
                    <div className="mt-3 flex justify-between mb-4 px-7 items-center">
                        <div className="pt-2">
                            <p className="text-xs">
                                Average: {" "}
